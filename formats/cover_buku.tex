...
\begin{titlepage}
  ...
  \colorbox{white}{%
    \begin{minipage}[c][5cm][c]{\textwidth}
      ...
      \begin{minipage}[c]{4cm}
        \includegraphics[width=3.5cm, keepaspectratio]{assets/pens/logo_pens.png}
      \end{minipage}
      \hfill
  ...
  \begin{center}
    ...
    {\fontsize{16}{20}\selectfont \textbf{\NamaPembimbingSatu}\par}
    {\fontsize{16}{20}\selectfont \textbf{NIP. \NIPPembimbingSatu}\par}
    \vspace{0.5cm}
    {\fontsize{16}{20}\selectfont \textbf{\NamaPembimbingDua}\par}
    {\fontsize{16}{20}\selectfont \textbf{NIP. \NIPPembimbingDua}\par}
    ...
    % Logika Pembimbing Industri/Dosen Tambahan
    \ifcsvoid{NamaPembimbingIndustri}{}{%
      \vspace{0.8cm}
      {\fontsize{16}{20}\bfseries\selectfont PEMBIMBING INDUSTRI\par}
      {\fontsize{16}{20}\selectfont \textbf{\NamaPembimbingIndustri}\par}
      \ifcsvoid{NIPPembimbingIndustri}{}{%
        {\fontsize{16}{20}\selectfont \textbf{NIP. \NIPPembimbingIndustri}\par}
      }
      \ifcsvoid{NamaPerusahaanIndustri}{}{%
        {\fontsize{16}{20}\selectfont \textbf{\NamaPerusahaanIndustri}\par}
      }
