%============================================================
% HALAMAN PENGESAHAN
% Watermark background: background_pens_repeated.png
%============================================================
\cleardoublepage
\thispagestyle{empty}
...
{\fontsize{14}{17}\selectfont
  \begin{tabular}{@{}l c l c@{}}
    ...
    &   & NIP. \NIPPembimbingSatu & \\[3pt] % Gap antar baris diturunkan dari 10pt menjadi 3pt
...
\begin{center}
  ...
  \vspace{1.5cm} % Tinggi ruang tanda tangan diturunkan dari 1.6cm menjadi 1.2cm
  {\fontsize{14}{17}\selectfont
