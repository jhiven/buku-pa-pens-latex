...
\begin{titlepage}
  ...
  \begin{center}
    ...
    % Dosen pembimbing: 16pt, bold, kapital
    {\fontsize{16}{20}\bfseries\selectfont DOSEN PEMBIMBING\par}
    \vspace{0.4cm}
    {\fontsize{16}{20}\bfseries\selectfont \NamaPembimbingSatu\par}
    {\fontsize{16}{20}\bfseries\selectfont NIP. \NIPPembimbingSatu\par}
    \vspace{0.6cm}
    {\fontsize{16}{20}\bfseries\selectfont \NamaPembimbingDua\par}
    {\fontsize{16}{20}\bfseries\selectfont NIP. \NIPPembimbingDua\par}
